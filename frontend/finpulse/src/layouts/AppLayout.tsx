...
import { LayoutDashboard, PieChart, Star, Bell, LogOut, Menu, X, Activity, Languages, User, BarChart2, Newspaper } from "lucide-react";
...
export default function AppLayout({ fullName }: AppLayoutProps) {
    ...
    const navItems = [
        ...
        { label: t("common.news"), path: "/news", icon: Newspaper },
    ];
